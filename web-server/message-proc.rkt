...
(define (message-proc name data)  
  (match data
    ((hash-table  ('type2 "guess") ('content content-json))
     ...
     (begin (room-broadcast name "message" "guess" (hash-set content-json 'name (symbol->string name)))
    ...
    ((hash-table  ('type2 "room") ('content content-json))
     ...
     (begin (room-broadcast name "message" "room" (hash-set content-json 'name (symbol->string name)))
            (match game-state
